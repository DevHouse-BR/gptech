...
$xml_submenu[7] = array (0 => "Info", 1 => "option=com_phocadownload&view=phocadownloadinfo", 2 => "components/com_phocadownload/assets/images/icon-16-pdl-menu-info.png");
