...
class PhocaDownloadHelperUpload
{
	...
	function canUpload( $file, &$err, $manager = '') {
	...
	$phocaSet['disallowed_file_types']	= PhocaDownloadHelper::getSettings( 'allowed_file_types', '' );	
	...
	$disallowedMimeType = PhocaDownloadHelper::getMimeTypeString($phocaSet['disallowed_file_types']);
		...
		// Max size of image
		$maxSize = (int) PhocaDownloadHelper::getSettings( 'upload_maxsize', 3000000 );	
