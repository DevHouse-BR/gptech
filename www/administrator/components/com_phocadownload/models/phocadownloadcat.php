...
class PhocaDownloadCpModelPhocaDownloadcat extends JModel
{
	...
	function _initData()
	{
		...
		if (empty($this->_data))
		{
			$phocadownload = new stdClass();
			$phocadownload->id					= 0;
			$phocadownload->parent_id			= 0;
			$phocadownload->section        		= 0;
			$phocadownload->title				= null;
			$phocadownload->name				= null;
			$phocadownload->alias				= null;
			$phocadownload->image				= null;
			$phocadownload->image_position		= null;
			$phocadownload->description			= null;
			$phocadownload->published			= 0;
			$phocadownload->checked_out			= 0;
			$phocadownload->checked_out_time	= 0;
			$phocadownload->editor				= null;
			$phocadownload->ordering			= 0;
			$phocadownload->access				= 0;
			$phocadownload->date				= 0;
			$phocadownload->count				= 0;
			$phocadownload->params				= null;
			$this->_data						= $phocadownload;
			return (boolean) $this->_data;
		}
		return true;
	}
