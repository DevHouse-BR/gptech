...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '35959de3ae9872cae83442b2ca1260b8');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
define('AFFILIATE_ENABLE', '');
define('PSHOP_ALLOW_FRONTENDADMIN_FOR_NOBACKENDERS', '');
define('PSHOP_IMG_RESIZE_ENABLE', '');
define('PSHOP_IMG_WIDTH', '120');
define('PSHOP_IMG_HEIGHT', '120');
...
define('VM_CURRENCY_CONVERTER_MODULE', 'convertECB.php.svn-base');
