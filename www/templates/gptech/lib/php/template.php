...
class YOOTemplate {
	...
	function replaceMootools() { 
		$this->document->_scripts = array_merge(array($this->url.'/lib/js/mootools/mootools-release-1.11.js' => 'text/javascript'), $this->document->_scripts);
		unset($this->document->_scripts[$this->document->baseurl.'/media/system/js/mootools.js']);
	}
	
	/* Colorswitcher */
	
	function getCurrentColor() {
		$color = isset($_COOKIE['ytcolor']) ? $_COOKIE['ytcolor'] : $this->params->get('color');
